...
import 'editarotr_gas_model.dart';
export 'editarotr_gas_model.dart';

class EditarotrGasWidget extends StatefulWidget {
  const EditarotrGasWidget({
    super.key,
  ...
  @override
  State<EditarotrGasWidget> createState() => _EditarotrGasWidgetState();
}

class _EditarotrGasWidgetState extends State<EditarotrGasWidget> {
  late EditarotrGasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarotrGasModel());
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'ur6forym' /* Puedes dejar una breve descrip... */,
                            ),
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'hq35y13w' /* Cantidad del efectivo... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    _model.edit = await queryDocumentsRecordOnce(
