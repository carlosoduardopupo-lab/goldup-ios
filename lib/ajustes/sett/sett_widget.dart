import '/acciones/ajustesde_noti/ajustesde_noti_widget.dart';
import '/acciones/biometria/biometria_widget.dart';
import '/acciones/cerrar_sesi/cerrar_sesi_widget.dart';
import '/acciones/correo_enviado/correo_enviado_widget.dart';
import '/acciones/eliminar_cuenta/eliminar_cuenta_widget.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 15.0),
                  child: Text(
                    currentUserEmail,
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.roboto(
                    ...
                    children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(SuscriptionsWidget.routeName);
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment:
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'ol0rua18' /* Ajustes de la Aplicación */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                      ...
                      Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '7phuxfjk' /* Ajustes de Notificaciones */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                          ...
                          if ((valueOrDefault<bool>(
                                      currentUserDocument?.isAccountsVinculated,
                                      false) ==
                                  true) &&
                              (valueOrDefault<bool>(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'x9pyxrnb' /* Terminos del Servicio */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '2dn5htey' /* Política de Privacidad */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
