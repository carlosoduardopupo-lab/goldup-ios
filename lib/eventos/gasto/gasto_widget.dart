...
class GastoWidget extends StatefulWidget {
  const GastoWidget({super.key});

  @override
  State<GastoWidget> createState() => _GastoWidgetState();
}

class _GastoWidgetState extends State<GastoWidget> {
  late GastoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GastoModel());
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'coajwhl4' /* Puedes dejar una breve descrip... */,
                            ),
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'y8ol0s6w' /* Cantidad del efectivo... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          children: [
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'g098xmia' /* Ajustes de Notificación */,
                                  ),
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'swdbx2rc' /* ( Horas de antelación para rec... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                          ...
                          for (int loop1Index = 0;
                            ...
                            await documentsRecordReference2
                              ...
                              occurrenceKey: functions
                                  .dateToOccurrenceKey(loop1Index.toString()),
