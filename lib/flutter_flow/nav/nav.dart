...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomeWidget() : Auth2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: SettWidget.routeName,
          path: SettWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => OperationsWidget(
            plaidAccountId: params.getParam(
              'plaidAccountId',
              ParamType.String,
            ),
            acountDocument: params.getParam(
              'acountDocument',
              ParamType.Document,
            ),
          ),
