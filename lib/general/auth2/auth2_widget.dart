...
import '/general/verificatucorreo/verificatucorreo_widget.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(32.0, 19.0, 32.0, 0.0),
                  child: Container(
                            ...
                            children: [
                              Align(
                                ...
                                child: TabBar(
                                  ...
                                  indicatorColor: Color(0xFF003326),
                                  indicatorWeight: 3.0,
                                  tabs: [
                                    Tab(
                                      text: FFLocalizations.of(context).getText(
                                        'qag2uhrp' /* Crear Cuenta */,
                                      ),
                                    ),
                                    Tab(
                                      text: FFLocalizations.of(context).getText(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'lbxsigxt' /* Comencemos rellenando los dato... */,
                                                ),
                                                textAlign: TextAlign.start,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                            text: FFLocalizations
                                                                    .of(context)
                                                                .getText(
                                                              '5tlzsdwh' /* He leído y acepto los  */,
                                                            ),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'qma3by2w' /* Rellene la siguiente informaci... */,
                                                ),
                                                textAlign: TextAlign.start,
                                                style: FlutterFlowTheme.of(
                                                        context)
