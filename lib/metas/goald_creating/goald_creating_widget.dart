...
import 'goald_creating_model.dart';
export 'goald_creating_model.dart';

class GoaldCreatingWidget extends StatefulWidget {
  const GoaldCreatingWidget({super.key});

  @override
  State<GoaldCreatingWidget> createState() => _GoaldCreatingWidgetState();
}

class _GoaldCreatingWidgetState extends State<GoaldCreatingWidget> {
  late GoaldCreatingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GoaldCreatingModel());
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'rkym5y2k' /* Puedes dejar una breve descrip... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'czekv8yc' /* Cantidad Total de la meta... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'qp5ofwzu' /* Cuenta Emisora (de donde se en... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '23xvfk9z' /* Cuenta Receptora ( La que reci... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                          ...
                          children: [
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '8zjn73f9' /* Ajustes de Notificación */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'qkvw6ba3' /* ( Horas de antelación para rec... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
